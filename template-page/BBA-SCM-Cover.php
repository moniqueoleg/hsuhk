        ...
        <div class="swiper mySwiper">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="boximg"><img src="static/images/banner.jpg" alt="banner"></div>
                    <div class="inner">
                        <div class="container">
                ...
                <div class="swiper-slide">
                    <div class="boximg"><img src="static/images/bs.png" alt="banner"></div>
                    <div class="inner">
                        <div class="container">
                            <div class="banText banText2">
                                <h1 class="fs36 bold blueText">Bachelor of Business<br/> Administration (Honours) in <br/>Supply Chain Management (BBA-SCM)</h1>
