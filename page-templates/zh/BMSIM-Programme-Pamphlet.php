...
<main>
    <section class="page-banner position-relative">
        <div class="inner">
            <div class="container">
                <h1 class="fs36 blueLight bold wow fadeInUp" title="Programme Pamphlet">Programme Pamphlet</h1>
               ...
               <div class="col-md-2 col-sm-12 col-xs-12 left">
                   <div class="mt-5">
                    ...
                    <ul>
                            ...
                            <li><a  href="../BMSIM-Programme-Pamphlet/" class="active" title="Programme Pamphlet">Programme Pamphlet</a> </li>        
               ...
               <div class="col-md-10 col-sm-12 col-xs-12 right">
                    <div class="pl-3 mt-5 mb-5">
                        ...
                        <div class="txt fs18  wow fadeInUp">
                            <object data="https://scm.hsu.edu.hk/attached/file/20221115/20221115092855_37041.pdf" type="application/pdf">
                                <embed src="https://scm.hsu.edu.hk/attached/file/20221115/20221115092855_37041.pdf">
                            </object>
                            <p class="mobile">This browser does not support PDFs. Please download the PDF to view it: <a href="https://scm.hsu.edu.hk/attached/file/20221115/20221115092855_37041.pdf" target="_blank">Download PDF</a>.</p>
                        </div>
