<?php
    ...
    $_SESSION['news_page_id'] = get_the_ID();
?>
<main>
    <section class="page-banner position-relative">
        <div class="inner">
            <div class="container">
                <h1 class="fs36 blueLight bold wow fadeInUp" title="最新消息">最新消息</h1>
               ...
               <div class="col-md-2 col-sm-12 col-xs-12 left">
                   <div class="mt-5">
                    ...
                    <div class="menu-box mt-3 wow fadeInUp">
                        <ul>         	        
                            <li><a  href="#" class="active" title="最新消息" >最新消息</a> </li>        
                            <li><a  href="<?=home_url()?>/events-zh" title="事件">事件</a> </li>   
                        </ul>
                    </div>
               </div>
               </div>
