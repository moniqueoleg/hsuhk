               ...
               <div class="col-md-10 col-sm-12 col-xs-12 right">
                    <div class="pl-3 mt-5 mb-5">
                        ...
                        <div class="txt fs18  wow fadeInUp">
                            ...
                            <div class="result">
                                <h2 class="fs28 bold blueLight mt-5">Class of 2022</h2>
                                ...
                                <!--这里是搜索后的内容-->
                                <!--<h2 class="fs28 bold blueLight mt-4">Class of 2021</h2>
                                <div class="IOlist">
                                    <div class="row">
                                        <div class="col-md-6  col-sm-12 col-xs-12 mb-3 wow fadeInUp">
                                            <a href="javascript:;">
                                ...
                                <h2 class="fs28 bold blueLight mt-4">Class of 2020</h2>
                                <div class="IOlist">
                                    <div class="row">
                                        <div class="col-md-6  col-sm-12 col-xs-12 mb-3 wow fadeInUp">
                                            <a href="javascript:;">
