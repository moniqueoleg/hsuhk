...
<main>
    <section class="page-banner position-relative">
        ...
        <div class="boximg"><img src="http://localhost/bingo/wp-content/themes/hsuhk/static/images/b88.jpg" alt="images"></div>
    </section>
    <div class="bread">
            <div class="container">
               ...
               <div class="col-md-10 col-sm-12 col-xs-12 right">
                    <div class="pl-3 mt-5 mb-5">
                        ...
                        <div class="txt fs18  wow fadeInUp">
                            <p>HSUHK offers entrance scholarships to qualified new local Year 1 students. For details, please visit <a href="https://admission.hsu.edu.hk/undergraduate-admissions/year-1-entry/hkdse-self-financing/entrance-scholarships/" target="_blank">HERE.</a></p>
                           
                        </div>

                        <div class="title fs28 mt-5 white  wow fadeInUp" title="Internship">Internship</div>
                        <div class="txt fs18  wow fadeInUp">
                            <p>We continuously cooperate and coordinate with different companies in Hong Kong and Mainland China to secure internship opportunities for our students. We are proud to say that our BMSIM graduates perform well in their employment. We believe that taking up an internship placement makes our graduates’ CV look really good. We are in particular thankful for some of our internship partners that have tailor-made projects for our students.</p>
                            <p>Some of our students had the internship placement in:</p>
                            <ul>
                                <li>Deloitte Touche Tohmatsu (Hong Kong)</li>
                                <li>HKTVmall</li>
                                <li>IKEA</li>
                                <li>Li & Fung Limited</li>
                                <li>Microsoft Corporation</li>
                                <li>Porsche Centre Hong Kong</li>
                                <li>Tencent</li>
                            ...
                            <div class="IOlist">
                                <div class="row">
                                    ...
                                    <div class="col-md-6  col-sm-12 col-xs-12 mb-3 wow fadeInUp">
                                        <a href="javascript:;">
                                            <div class="imgs"><img src="http://localhost/bingo/wp-content/themes/hsuhk/static/images/shd.jpg" alt="pic"></div>
                                            <div class="right">
                                                ...
                                                <div class="conbox">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4 col-sm-12 col-xs-12 mb-3">
                                                            <div class='pic'><img src="http://localhost/bingo/wp-content/themes/hsuhk/static/images/sh8.jpg" alt="pic"></div>
                                                        </div>
                            ...
                            <div class="sdlist">
                                <div class="row">
                                    <div class="col-md-4 col-sm-12 col-xs-12 mt-3 wow fadeInUp">
                                        <div class="imgs"><img src="http://localhost/bingo/wp-content/themes/hsuhk/static/images/h.jpg" alt="pic"></div>
                                    </div>
                                    <div class="col-md-4 col-sm-12 col-xs-12 mt-3 wow fadeInUp">
                                        <div class="imgs"><img src="http://localhost/bingo/wp-content/themes/hsuhk/static/images/h.jpg" alt="pic"></div>
                                    </div>
                        ...
                        <div class="txt fs18  wow fadeInUp">
                            ...
                            <p>For a detailed list of institutions, please click <a href="https://sao.hsu.edu.hk/our-services/student-exchange/overseas-partners/ " target="_blank">HERE</a>.</p>
                            <div class="sdlist">
                                <div class="row">
                                    <div class="col-md-4 col-sm-12 col-xs-12 mt-3 wow fadeInUp">
                                        <div class="imgs"><img src="http://localhost/bingo/wp-content/themes/hsuhk/static/images/4.jpg" alt="pic"></div>
                                    </div>
                                    <div class="col-md-4 col-sm-12 col-xs-12 mt-3 wow fadeInUp">
                                        <div class="imgs"><img src="http://localhost/bingo/wp-content/themes/hsuhk/static/images/5.jpg" alt="pic"></div>
                                    </div>
                                    <div class="col-md-4 col-sm-12 col-xs-12 mt-3 wow fadeInUp">
                                        <div class="imgs"><img src="http://localhost/bingo/wp-content/themes/hsuhk/static/images/6.jpg" alt="pic"></div>
                                    </div>
                                </div>
                            </div>
