           ...
           <div class="row mt-5">
               <div class='col-md-4 col-sm-12 col-xs-12 mt-3 wow fadeInUp'>
                   <a href="">
                        ...
                        <div class="boximg">
                           <img src="<?=get_template_directory_uri()?>/static/images/n1.jpg" alt="pic">
                        
                        </div>
                        <div class="con fs20">
                            <p>BSc-DSBI 2022/23 Service Learning Programme Student Presentation X Company Visit at Food Grace on 12 Jan 2023 </p>
                        </div>
                    </a>
               </div>
               <div class='col-md-4 col-sm-12 col-xs-12 mt-3 wow fadeInUp'>
                   <a href="">
                        <div class="date">
                               ...
                               <em class="year">Dec, 2022</em>
                        </div>
                        <div class="boximg">
                           <img src="<?=get_template_directory_uri()?>/static/images/n2.jpg" alt="pic">
                        
                        </div>
                        <div class="con fs20">
                            <p>Executive Master of Science in Insurance Graduate Photo-Taking and Gathering</p>
                        </div>
                    </a>
               </div>
               <div class='col-md-4 col-sm-12 col-xs-12 mt-3 wow fadeInUp'>
                   <a href="">
                        ...
                        <div class="boximg">
                           <img src="<?=get_template_directory_uri()?>/static/images/n3.jpg" alt="pic">
                      
                        </div>
                        <div class="con fs20">
                            <p>BSc-AIN Graduate Photo-Taking and Gathering</p>
                        </div>
                    </a>
               </div>
              
           </div>
           <a href="" class="more-n mt-5 mb-4 fs20 wow fadeInUp">More News</a>
